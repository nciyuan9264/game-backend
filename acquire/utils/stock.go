...
var premiumStock = []StockInfo{
	...
	{[2]int{21, 30}, 1400, 10000, 5000},
	{[2]int{31, 40}, 1700, 11000, 5500},
	{[2]int{41, 1000}, 2000, 12000, 6000},
}
...
var mediumStock = []StockInfo{
	...
	{[2]int{21, 30}, 1300, 9000, 4500},
	{[2]int{31, 40}, 1600, 10000, 5000},
	{[2]int{41, 1000}, 1900, 11000, 5500},
}
...
var lowStock = []StockInfo{
	...
	{[2]int{21, 30}, 1200, 8000, 4000},
	{[2]int{31, 40}, 1500, 9000, 4500},
	{[2]int{41, 1000}, 1800, 10000, 5000},
}
